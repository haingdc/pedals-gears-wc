...
const meta: Meta = {
  title: "Components/TimerSession/components/StopWatch",
  component: "stop-watch",
  render: (args) =>
    html`
      <stop-watch value="${args.value}"> </stop-watch>
    `,
  argTypes: {
    value: {
      control: "number",
  ...
  render: () => {
    return html`
      <div style="display: flex; flex-direction: column; gap: 16px;">
        <div>
          <h4 style="margin: 0 0 8px 0;">Normal Time (1 hour, 30 minutes, 45 seconds):</h4>
          <stop-watch value="${1 * 60 * 60 * 1000 + 30 * 60 * 1000 + 45 * 1000}"></stop-watch>
        </div>
